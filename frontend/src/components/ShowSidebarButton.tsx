...
const ShowSidebarButton: React.FC<showSidebarButtonType> = ({
  ...
  return (
    <motion.div
      className="hidden md:absolute left-0 bottom-2 mb-0  bg-custom-button_bg py-4 rounded-r-full px-4 cursor-pointer md:flex justify-center items-center text-custom-primary_text gap-4"
